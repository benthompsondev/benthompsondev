...
- Azure AD / Microsoft Entra ID and hybrid identity troubleshooting
- Active Directory administration, account workflows, and group management
- SCCM, Intune, deployment rings, update workflows, and endpoint management
- Windows, Windows Server, and Linux administration fundamentals
- Technical documentation, repeatable processes, and user-focused support
...
**Earlier IT background**

- IT specialist and desktop support roles across networking, security software deployment, imaging, print services, licensing, and end-user support.
- Python PASS Leader at Mohawk College, where I created beginner programming materials and helped students learn core programming concepts.
