...
| My newest shipped app | [UsageLoop](https://benthompsondev.github.io/usageloop/) | Windows app that starts your next Codex five-hour window on a schedule you set, with separate weekday and weekend times and an overnight pause. Local-first, no API key. Does not add quota or bypass limits |
