...
| My newest shipped app | [UsageLoop](https://benthompsondev.github.io/usageloop/) | Windows and Linux app that starts your next Codex five-hour window on a schedule you set, with separate weekday and weekend times and an overnight pause. Local-first, no API key. Does not add quota or bypass limits |
...
| [usageloop](https://github.com/benthompsondev/usageloop) | UsageLoop, a Codex window scheduler for Windows and Linux | [Product page](https://benthompsondev.github.io/usageloop/), [Releases](https://github.com/benthompsondev/usageloop/releases/latest), [Project spec](https://github.com/benthompsondev/usageloop/blob/main/PROJECT_SPEC.md) | PySide6 desktop app and CLI, local JSON-RPC to the Codex app-server, evidence-based classification before any action, weekly scheduling with an overnight pause, and packaging with a checksum-gated updater |
...
[UsageLoop](https://github.com/benthompsondev/usageloop) is a small Windows and Linux app for Codex subscribers. It answers one question I kept guessing at: is my five-hour limit window actually counting down right now, or is the clock not running yet?
